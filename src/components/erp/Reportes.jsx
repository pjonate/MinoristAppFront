...
export default function Reportes() {
  ...
  const ProductosMasRentables = async () => {
    try {
      const responseRentables = await fetch(`/api/report/productos-mas-rentables?periodo=${periodoRentable}`);
  ...
  const VentasDiarias = async () => {
    try {
      const responseVentas = await fetch(`/api/report/ventas-diarias?periodo=${periodoVentas}`);
  ...
  const obtenerProductosStockBajo = async () => {
    try {
      const response = await fetch("/api/report/productos-stock-bajo");
  ...
  const obtenerProductosAntiguos = async () => {
    try {
      const responseAntiguos = await fetch("/api/report/productos-sin-ventas");
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <thead style={{ backgroundColor: "#dad87a" }}>
                  <tr>
